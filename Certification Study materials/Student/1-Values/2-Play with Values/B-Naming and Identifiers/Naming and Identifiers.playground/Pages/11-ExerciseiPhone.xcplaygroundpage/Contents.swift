 ...
 */
 let iPhoneStorageCapacity = 8 * 1000
 let occupiedSpaceInPhone =  3 * 1000
 let freeSpaceIniPhone = iPhoneStorageCapacity - occupiedSpaceInPhone
 let spaceTakenByOneMinVideo = 150
let  totalMinutOfVideo = freeSpaceIniPhone / spaceTakenByOneMinVideo
