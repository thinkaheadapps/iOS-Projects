...
let totalNumberOfAnimals = numberOfRabbits + numberOfCats + numberOfTurtles + numberOfHamsters + numberOfPotBelliedPigs + numberOfFish + numberOfSnakes

let totalNumberOfMammals = numberOfRabbits + numberOfCats + numberOfHamsters + numberOfPotBelliedPigs
